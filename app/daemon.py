...
def fetch_account_snapshot(ex: HyperliquidClient, symbol: str) -> dict[str, object]:
...
def save_json_file(path: Path, data: dict[str, object]) -> None:
...
def main() -> None:
    ...
    logger.info("daemon 启动，等待控制指令: %s", DAEMON_CONTROL_FILE)
